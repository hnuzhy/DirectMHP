...
def convert_to_coco_style(source_img, target_img, source_json, target_json, coco_dict):
    ...
    for img_name in tqdm(json_img_dict.keys()):
        ...
        os.system('ln -s %s %s'%(source_img_path, target_img_path))
...
if __name__ == '__main__':
    ...
    # train_image_file = "/datasdc/zhouhuayi/dataset/headpose/HeadCube3D/images/300W_LP/"
    # train_image_file_coco = "./HeadCube3D/images/train/"
    # if os.path.exists(train_image_file_coco):
        # shutil.rmtree(train_image_file_coco)
    # os.mkdir(train_image_file_coco)
    ...
    val_image_file = "/datasdc/zhouhuayi/dataset/headpose/HeadCube3D/images/BIWI_test/"
    val_image_file_coco = "./HeadCube3D/images/validation/"
    if os.path.exists(val_image_file_coco):
        shutil.rmtree(val_image_file_coco)
    os.mkdir(val_image_file_coco)
    val_json_file = "./HeadCube3D/annotations/BIWI_test.json"
    val_json_file_coco = "./HeadCube3D/annotations/BIWI_test_coco_style.json"
